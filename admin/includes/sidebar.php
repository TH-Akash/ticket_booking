            ...
            <div class="col-md-2 sidebar_part">
              ...
              <div class="menu">
                  <ul>
                    ...
                    <li><a href="all-tickets.php"><i class="fa fa-ticket"></i> All Tickets</a></li>
                    <li><a href="contact-message.php"><i class="fa fa-bandcamp"></i> Contact Message</a></li>
